...
public class Step extends SourceArtifact {
    ...
    */
    ...
    private Map<String, XStep> steps = new HashMap<String, XStep>(); // Innovimax: new property (debug)
    
    // Innovimax: new function (debug)
    public void setRunStep(int channel, XStep step) {
        steps.put(Integer.toString(channel), step);
    }
