    ...
    */
    ...
    public void instantiate(Step step) {
        ...
        for (Step substep : decl.subpipeline()) {
            // Innovimax: check stream all step            
            ...
            if (XProcConstants.p_choose.equals(substep.getType())) {
                ...
                newstep.instantiate(substep);
                newstep.setStreamed(true);
                newstep.setStreamAll(streamAll);
                if (streamAll) {
                    runtime.getTracer().debug(this,null,-1,null,null,"  STEP > MODE SWAP TO STREAM");
                } else {
                    runtime.getTracer().debug(this,null,-1,null,null,"  STEP > MODE SWAP TO STREAM OR DOM");
                }                
